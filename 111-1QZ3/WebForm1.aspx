<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="_111_1QZ3.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btn_Submit" runat="server" Text="送出" Width="80px" PostBackUrl="WebForm2.aspx" />
        </div>
    </form>
</body>
</html>
